#include <Processors/QueryPlan/ReadFromMergeTreeForGRPCQueryPlan.h>
...
struct ReadFromMergeTreeForGRPCQueryPlan::AnalysisResult
{
...
ReadFromMergeTreeForGRPCQueryPlan::ReadFromMergeTreeForGRPCQueryPlan(
...
Pipe ReadFromMergeTreeForGRPCQueryPlan::readFromPool(
...
ProcessorPtr ReadFromMergeTreeForGRPCQueryPlan::createSource(
...
Pipe ReadFromMergeTreeForGRPCQueryPlan::readInOrder(
    RangesInDataParts parts_with_range,
    Names required_columns,
...
Pipe ReadFromMergeTreeForGRPCQueryPlan::read(
...
Pipe ReadFromMergeTreeForGRPCQueryPlan::spreadMarkRangesAmongStreams(
    RangesInDataParts && parts_with_ranges,
...
Pipe ReadFromMergeTreeForGRPCQueryPlan::spreadMarkRangesAmongStreamsWithOrder(
    RangesInDataParts && parts_with_ranges,
    const Names & column_names,
...
Pipe ReadFromMergeTreeForGRPCQueryPlan::spreadMarkRangesAmongStreamsFinal(
    RangesInDataParts && parts_with_ranges,
    const Names & column_names,
    ActionsDAGPtr & out_projection)
{
...
ReadFromMergeTreeForGRPCQueryPlan::AnalysisResult ReadFromMergeTreeForGRPCQueryPlan::selectRangesToRead(MergeTreeData::DataPartsVector parts) const
{
...
void ReadFromMergeTreeForGRPCQueryPlan::initializePipeline(QueryPipeline & pipeline, const BuildQueryPipelineSettings &)
{
...
void ReadFromMergeTreeForGRPCQueryPlan::describeActions(FormatSettings & format_settings) const
{
    auto result = selectRangesToRead(prepared_parts);
...
void ReadFromMergeTreeForGRPCQueryPlan::describeActions(JSONBuilder::JSONMap & map) const
{
    auto result = selectRangesToRead(prepared_parts);
...
void ReadFromMergeTreeForGRPCQueryPlan::describeIndexes(FormatSettings & format_settings) const
{
    auto result = selectRangesToRead(prepared_parts);
...
void ReadFromMergeTreeForGRPCQueryPlan::describeIndexes(JSONBuilder::JSONMap & map) const
{
    auto result = selectRangesToRead(prepared_parts);
    auto index_stats = std::move(result.index_stats);
