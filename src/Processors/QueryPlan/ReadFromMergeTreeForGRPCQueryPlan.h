...
class ReadFromMergeTreeForGRPCQueryPlan final : public ISourceStep
{
public:

    ReadFromMergeTreeForGRPCQueryPlan(
    ...
    String getName() const override { return "ReadFromMergeTreeForGRPCQueryPlan"; }
