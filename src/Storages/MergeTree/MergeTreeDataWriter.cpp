        ...
        switch (data.merging_params.mode)
        {
            ...
            case MergeTreeData::MergingParams::PartialReplacing:
                return std::make_shared<PartialReplacingSortedAlgorithm>(
                    block, 1, sort_description, data.merging_params.part_cols_indexes_column, data.merging_params.primary_keys, data.merging_params.all_column_names, block_size + 1);
        }
